...
M6a. Install kit docs by FILE COPY, never by Write-ing their content (regeneration silently mutates calibrated wording). For EACH of the 21 kit docs, in order:
